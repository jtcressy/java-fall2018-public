...
public abstract class BadgeFirstNameDataCallback implements ProfileDataCallback, DataSentCallback, BadgeFirstNameCallback {
    @Override
    ...
    private void parse(@NonNull BluetoothDevice device, @NonNull Data data) {
        ...
        onFirstNameChanged(device, value);
    }
}
